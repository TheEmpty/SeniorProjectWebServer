...
module.exports = function*(next) {
  ...
  console.info(this.request.ip + ' - ' + this.request.method.bold + ' ' + this.request.url + ' => ' + niceStatus(this.response) + ' in ' + this.response.header['x-response-time'] + 'ms (' + (this.response.header['content-length'] || 0) + ' characters)');
};
